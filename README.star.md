...
### Python 
- [xiaogpt](https://github.com/yihong0618/xiaogpt) 5450⭐️ Play ChatGPT with xiaomi AI speaker
...
- [FastChat](https://github.com/lm-sys/FastChat) 35060⭐️ An open platform for training, serving, and evaluating large language model based chatbots
...
- [email-automation](https://github.com/xiaowuc2/ChatGPT-Python-Applications/tree/main/email-automation) 129⭐️ : Automates news briefing / blogging with email automation. 
- [chatbot](https://github.com/xiaowuc2/ChatGPT-Python-Applications/tree/main/chatbot) 129⭐️ : ChatGPT Integrated faster and secure chatbot hosted on cloud.
- [whisper speech-to-text](https://github.com/xiaowuc2/ChatGPT-Python-Applications/tree/main/whisper-speech-text) 129⭐️ : OpnAI's whisper is a library to convert speech to text. 
...
- [Auto-GPT](https://github.com/Torantulino/Auto-GPT) 162699⭐️ An experimental open-source attempt to make GPT-4 fully autonomous
- [GPTCache](https://github.com/zilliztech/GPTCache) 6563⭐️ GPTCache is a library for creating semantic cache to store responses from LLM queries
- [gpt4free](https://github.com/xtekky/gpt4free) 58530⭐️ decentralising the Ai Industry, free gpt-4/3.5 scripts through several reverse engineered api's ( poe.com, phind.com, chat.openai.com etc...)
- [gpt4free-ts](https://github.com/xiangsx/gpt4free-ts) 7500⭐️ Providing a free OpenAI GPT-4 API ! This is a replication project for the typescript version of xtekky/gpt4free
- [MiniGPT-4](https://github.com/Vision-CAIR/MiniGPT-4) 25030⭐️ MiniGPT-4: Enhancing Vision-language Understanding with Advanced Large Language Models
...
- [privateGPT](https://github.com/imartinez/privateGPT) 52478⭐️ Interact privately with your documents using the power of GPT, 100% privately, no data leaks
...
- [Unofficial API in JS/TS](https://github.com/transitive-bullshit/chatgpt-api) 15705⭐️ Node.js client for the official ChatGPT API. 
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 12120⭐️ Clone of ChatGPT, uses official model, reverse-engineered UI, with AI model switching, message search, and prompt templates
...
- [Automate your browser with GPT-4](https://github.com/TaxyAI/browser-extension) 825⭐️ uses GPT-4 to control your browser and perform repetitive actions on your behalf
...
- [Multi-platform desktop app (Windows, Mac, Linux)](https://github.com/lencx/ChatGPT) 51020⭐️ powered by ChatGPT & Tauri
...
- [gpt4all](https://github.com/nomic-ai/gpt4all) 65537⭐️ a chatbot trained on a massive collection of clean assistant data including code, stories and dialogue
- [chatgpt-dingtalk](https://github.com/eryajf/chatgpt-dingtalk) 2073⭐️ GPT-3.5 Let your work efficiency take off directly
- [ChatBot-TGLM6B](https://github.com/Lakr233/ChatBot-TGLM6B) 133⭐️ ChatGLM-6B Bot for Telegram
- [gpt4-pdf-chatbot-langchain](https://github.com/mayooear/gpt4-pdf-chatbot-langchain) 14668⭐️ GPT4 & LangChain Chatbot for large PDF docs
...
- [chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) 26592⭐️ Wechat robot based on ChatGPT, which using OpenAI api and itchat library
...
- [chatgpt_academic](https://github.com/binary-husky/chatgpt_academic) 59846⭐️ Specialized ChatGPT extension for scientific research work, optimized for enhancing the experience of polishing academic papers
- [chatbot-ui](https://github.com/mckaywrigley/chatbot-ui) 26877⭐️ An open source ChatGPT UI
- [ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) 70973⭐️ One-Click to deploy your own ChatGPT web UI
...
- [AgentGPT](https://github.com/reworkd/AgentGPT) 30284⭐️ 🤖 Assemble, configure, and deploy autonomous AI Agents in your browser.
...
- [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) 105584⭐️  ChatGPT prompts that works well.
...
- [Mr.-Ranedeer-AI-Tutor](https://github.com/JushBJJ/Mr.-Ranedeer-AI-Tutor) 27325⭐️ A GPT-4 AI Tutor Prompt for customizable personalized learning experiences
- [prompt-engineering-for-developers](https://github.com/datawhalechina/prompt-engineering-for-developers) 9930⭐️ 吴恩达《ChatGPT Prompt Engineering for Developers》课程中文版
...
- [LangGPT](https://github.com/yzfly/LangGPT) 4060⭐️ Empowering everyone to become a prompt expert!🚀
...
- [ChatGPT conversation saving bookmark](https://github.com/jcubic/chat-gpt) 282⭐️ Save chatGPT conversation as HTML file
- [WebGPT](https://github.com/0hq/WebGPT) 3560⭐️ Run GPT model on the browser with WebGPU. An implementation of GPT inference in less than ~2000 lines of vanilla Javascript.
- [KeepChatGPT](https://github.com/xcanwin/KeepChatGPT) 13955⭐️ A UserScript that enables ChatGPT to chat smoothly, never experiencing network errors again, and no need to refresh the webpage anymore.
