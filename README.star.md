...
- [Auto-GPT](https://github.com/Torantulino/Auto-GPT) 162800⭐️ An experimental open-source attempt to make GPT-4 fully autonomous
- [GPTCache](https://github.com/zilliztech/GPTCache) 6578⭐️ GPTCache is a library for creating semantic cache to store responses from LLM queries
- [gpt4free](https://github.com/xtekky/gpt4free) 58591⭐️ decentralising the Ai Industry, free gpt-4/3.5 scripts through several reverse engineered api's ( poe.com, phind.com, chat.openai.com etc...)
...
- [privateGPT](https://github.com/imartinez/privateGPT) 52546⭐️ Interact privately with your documents using the power of GPT, 100% privately, no data leaks
...
- [DemoGPT](https://github.com/melih-unsal/DemoGPT) 1602⭐️ 🧩 DemoGPT enables you to create quick demos by just using prompts.
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 12189⭐️ Clone of ChatGPT, uses official model, reverse-engineered UI, with AI model switching, message search, and prompt templates
...
- [Multi-platform desktop app (Windows, Mac, Linux)](https://github.com/lencx/ChatGPT) 51115⭐️ powered by ChatGPT & Tauri
...
- [cheetah](https://github.com/leetcode-mafia/cheetah) 3832⭐️ Whisper & GPT-based app for passing remote SWE interviews
...
- [chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) 26853⭐️ Wechat robot based on ChatGPT, which using OpenAI api and itchat library
...
- [ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) 71159⭐️ One-Click to deploy your own ChatGPT web UI
...
- [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) 105711⭐️  ChatGPT prompts that works well.
