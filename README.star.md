...
- [FastChat](https://github.com/lm-sys/FastChat) 18976⭐️ An open platform for training, serving, and evaluating large language model based chatbots
...
- [Auto-GPT](https://github.com/Torantulino/Auto-GPT) 127481⭐️ An experimental open-source attempt to make GPT-4 fully autonomous
- [GPTCache](https://github.com/zilliztech/GPTCache) 3027⭐️ GPTCache is a library for creating semantic cache to store responses from LLM queries
- [gpt4free](https://github.com/xtekky/gpt4free) 33831⭐️ decentralising the Ai Industry, free gpt-4/3.5 scripts through several reverse engineered api's ( poe.com, phind.com, chat.openai.com etc...)
- [MiniGPT-4](https://github.com/Vision-CAIR/MiniGPT-4) 18433⭐️ MiniGPT-4: Enhancing Vision-language Understanding with Advanced Large Language Models
- [chatgpt-tool-hub](https://github.com/goldfishh/chatgpt-tool-hub) 250⭐️ An open-source chatgpt tool ecosystem where you can combine tools with chatgpt and use natural language to do anything.
...
- [Unoffical API in Python](https://github.com/acheong08/ChatGPT) 25311⭐️ Reverse engineered ChatGPT API
