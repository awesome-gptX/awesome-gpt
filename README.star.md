...
### Python 
- [xiaogpt](https://github.com/yihong0618/xiaogpt) 6667⭐️ Play ChatGPT with xiaomi AI speaker
...
- [FastChat](https://github.com/lm-sys/FastChat) 39152⭐️ An open platform for training, serving, and evaluating large language model based chatbots
...
- [Auto-GPT](https://github.com/Torantulino/Auto-GPT) 179071⭐️ An experimental open-source attempt to make GPT-4 fully autonomous
...
- [gpt4free](https://github.com/xtekky/gpt4free) 65416⭐️ decentralising the Ai Industry, free gpt-4/3.5 scripts through several reverse engineered api's ( poe.com, phind.com, chat.openai.com etc...)
...
- [privateGPT](https://github.com/imartinez/privateGPT) 56657⭐️ Interact privately with your documents using the power of GPT, 100% privately, no data leaks
...
- [Casibase](https://github.com/casibase/casibase) 4130⭐️ Casibase provides an open source LangChain-like AI knowledge database and chatbot built using Golang with Admin UI and multi-model support (DeepSeek R1, ChatGPT, Claude, Llama 3, HuggingFace, etc.). Ability to provide AI-driven smart replies.
...
- [Unofficial API in JS/TS](https://github.com/transitive-bullshit/chatgpt-api) 17998⭐️ Node.js client for the official ChatGPT API. 
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 30813⭐️ Clone of ChatGPT, uses official model, reverse-engineered UI, with AI model switching, message search, and prompt templates
...
- [openai-translator](https://github.com/yetone/openai-translator) 24639⭐️ A Chrome extension for word translation based on ChatGPT API
...
- [gptel](https://github.com/karthink/gptel) 2943⭐️ GPTel is a simple Large Language Model chat client for Emacs, with support for multiple models and backends.
...
- [gpt4all](https://github.com/nomic-ai/gpt4all) 76811⭐️ a chatbot trained on a massive collection of clean assistant data including code, stories and dialogue
...
- [gpt4-pdf-chatbot-langchain](https://github.com/mayooear/gpt4-pdf-chatbot-langchain) 16067⭐️ GPT4 & LangChain Chatbot for large PDF docs
...
- [chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) 39393⭐️ Wechat robot based on ChatGPT, which using OpenAI api and itchat library
...
- [ai-research-for-practise](https://github.com/phodal/ai-research-for-practise) 4936⭐️ A powerful image generation model, can through the study of the evolution of an image to generate a new image
- [roomGPT](https://github.com/Nutlope/roomGPT) 10568⭐️ Upload a photo of your room to generate your dream room with AI
- [DocsGPT](https://github.com/arc53/DocsGPT) 17205⭐️ GPT-powered chat for documentation search & assistance
...
- [chatgpt_academic](https://github.com/binary-husky/chatgpt_academic) 69346⭐️ Specialized ChatGPT extension for scientific research work, optimized for enhancing the experience of polishing academic papers
- [chatbot-ui](https://github.com/mckaywrigley/chatbot-ui) 32486⭐️ An open source ChatGPT UI
- [ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) 86126⭐️ One-Click to deploy your own ChatGPT web UI
- [BibiGPT](https://github.com/JimmyLv/BibiGPT) 5743⭐️ One-click summary for video & audio content: Bilibili | YouTube | Websites丨Podcasts | Meetings | Local files, etc
...
- [AgentGPT](https://github.com/reworkd/AgentGPT) 35073⭐️ 🤖 Assemble, configure, and deploy autonomous AI Agents in your browser.
...
- [ChatALL](https://github.com/sunner/ChatALL) 16048⭐️ Concurrently chat with ChatGPT, Bing Chat, bard, Alpaca, Vincuna, Claude, ChatGLM, MOSS, iFlytek Spark, ERNIE and more, discover the best answers
...
- [chatgpt-android](https://github.com/skydoves/chatgpt-android) 3849⭐️ ChatGPT Android demonstrates OpenAI's ChatGPT on Android with Stream Chat SDK for Compose
- [ChatGPT for WearOS](https://github.com/DevEmperor/ChatGPT-WearOS) 118⭐️ A powerful ChatGPT app for all WearOS devices
...
- [README-AI](https://github.com/eli64s/README-AI) 2723⭐️ Generate beautiful, informative, and well-structured README.md files. 
...
- [aicommits](https://github.com/Nutlope/aicommits) 8696⭐️ A CLI that writes your git commit messages for you with AI
...
- [autodoc](https://github.com/context-labs/autodoc) 2246⭐️ Autodoc is a experimental toolkit for auto-generating codebase documentation for git repositories using Large Language Models, like GPT-4 or Alpaca. 
...
- [openai-pr-reviewer](https://github.com/fluxninja/openai-pr-reviewer) 1940⭐️ OpenAI ChatGPT based PR reviewer and summarizer
...
- [Beelzebub ChatGPT Honeypot](https://github.com/mariocandela/beelzebub) 1579⭐️ A secure honeypot framework low code, extremely easy to configure by yaml 🚀
...
- [ChatGPT-Shortcut](https://github.com/rockbenben/ChatGPT-Shortcut) 6401⭐️ The ChatGPT Shortcut page displays all the prompts by default, and is divided into label area, search area, and prompt display area
...
- [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) 135406⭐️  ChatGPT prompts that works well.
...
- [prompt-engineering-for-developers](https://github.com/datawhalechina/prompt-engineering-for-developers) 21541⭐️ 吴恩达《ChatGPT Prompt Engineering for Developers》课程中文版
...
- [LangGPT](https://github.com/yzfly/LangGPT) 10874⭐️ Empowering everyone to become a prompt expert!🚀
...
- [chatgpt-exporter](https://github.com/pionxzh/chatgpt-exporter) 1866⭐️ Export and Share your ChatGPT conversation history
