...
- [Auto-GPT](https://github.com/Torantulino/Auto-GPT) 178952⭐️ An experimental open-source attempt to make GPT-4 fully autonomous
...
- [privateGPT](https://github.com/imartinez/privateGPT) 56631⭐️ Interact privately with your documents using the power of GPT, 100% privately, no data leaks
...
- [Casibase](https://github.com/casibase/casibase) 4109⭐️ Casibase provides an open source LangChain-like AI knowledge database and chatbot built using Golang with Admin UI and multi-model support (DeepSeek R1, ChatGPT, Claude, Llama 3, HuggingFace, etc.). Ability to provide AI-driven smart replies.
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 30688⭐️ Clone of ChatGPT, uses official model, reverse-engineered UI, with AI model switching, message search, and prompt templates
...
- [openai-translator](https://github.com/yetone/openai-translator) 24628⭐️ A Chrome extension for word translation based on ChatGPT API
...
- [Multi-platform desktop app (Windows, Mac, Linux)](https://github.com/lencx/ChatGPT) 54160⭐️ powered by ChatGPT & Tauri
...
- [gptel](https://github.com/karthink/gptel) 2927⭐️ GPTel is a simple Large Language Model chat client for Emacs, with support for multiple models and backends.
...
- [gpt4all](https://github.com/nomic-ai/gpt4all) 76785⭐️ a chatbot trained on a massive collection of clean assistant data including code, stories and dialogue
...
- [gpt4-pdf-chatbot-langchain](https://github.com/mayooear/gpt4-pdf-chatbot-langchain) 16046⭐️ GPT4 & LangChain Chatbot for large PDF docs
...
- [chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) 39333⭐️ Wechat robot based on ChatGPT, which using OpenAI api and itchat library
...
- [ai-research-for-practise](https://github.com/phodal/ai-research-for-practise) 4927⭐️ A powerful image generation model, can through the study of the evolution of an image to generate a new image
- [roomGPT](https://github.com/Nutlope/roomGPT) 10569⭐️ Upload a photo of your room to generate your dream room with AI
- [DocsGPT](https://github.com/arc53/DocsGPT) 17179⭐️ GPT-powered chat for documentation search & assistance
...
- [chatgpt_academic](https://github.com/binary-husky/chatgpt_academic) 69316⭐️ Specialized ChatGPT extension for scientific research work, optimized for enhancing the experience of polishing academic papers
- [chatbot-ui](https://github.com/mckaywrigley/chatbot-ui) 32440⭐️ An open source ChatGPT UI
- [ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) 86049⭐️ One-Click to deploy your own ChatGPT web UI
- [BibiGPT](https://github.com/JimmyLv/BibiGPT) 5732⭐️ One-click summary for video & audio content: Bilibili | YouTube | Websites丨Podcasts | Meetings | Local files, etc
...
- [README-AI](https://github.com/eli64s/README-AI) 2710⭐️ Generate beautiful, informative, and well-structured README.md files. 
...
- [aicommits](https://github.com/Nutlope/aicommits) 8695⭐️ A CLI that writes your git commit messages for you with AI
...
- [openai-pr-reviewer](https://github.com/fluxninja/openai-pr-reviewer) 1932⭐️ OpenAI ChatGPT based PR reviewer and summarizer
...
- [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) 135181⭐️  ChatGPT prompts that works well.
...
- [prompt-engineering-for-developers](https://github.com/datawhalechina/prompt-engineering-for-developers) 21315⭐️ 吴恩达《ChatGPT Prompt Engineering for Developers》课程中文版
...
- [LangGPT](https://github.com/yzfly/LangGPT) 10726⭐️ Empowering everyone to become a prompt expert!🚀
...
- [chatgpt-exporter](https://github.com/pionxzh/chatgpt-exporter) 1855⭐️ Export and Share your ChatGPT conversation history
