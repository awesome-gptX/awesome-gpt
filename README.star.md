...
- [FastChat](https://github.com/lm-sys/FastChat) 35078⭐️ An open platform for training, serving, and evaluating large language model based chatbots
...
- [Auto-GPT](https://github.com/Torantulino/Auto-GPT) 162723⭐️ An experimental open-source attempt to make GPT-4 fully autonomous
- [GPTCache](https://github.com/zilliztech/GPTCache) 6566⭐️ GPTCache is a library for creating semantic cache to store responses from LLM queries
...
- [gpt4free-ts](https://github.com/xiangsx/gpt4free-ts) 7502⭐️ Providing a free OpenAI GPT-4 API ! This is a replication project for the typescript version of xtekky/gpt4free
- [MiniGPT-4](https://github.com/Vision-CAIR/MiniGPT-4) 25034⭐️ MiniGPT-4: Enhancing Vision-language Understanding with Advanced Large Language Models
...
- [privateGPT](https://github.com/imartinez/privateGPT) 52490⭐️ Interact privately with your documents using the power of GPT, 100% privately, no data leaks
...
- [Unofficial API in Python](https://github.com/acheong08/ChatGPT) 27964⭐️ Reverse engineered ChatGPT API
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 12136⭐️ Clone of ChatGPT, uses official model, reverse-engineered UI, with AI model switching, message search, and prompt templates
- [DelphiOpenAI](https://github.com/HemulGM/DelphiOpenAI) 215⭐️ OpenAI API client for Delphi. Use ChatGPT, DALL-E and other products
...
- [Automate your browser with GPT-4](https://github.com/TaxyAI/browser-extension) 826⭐️ uses GPT-4 to control your browser and perform repetitive actions on your behalf
...
- [openai-translator](https://github.com/yetone/openai-translator) 23043⭐️ A Chrome extension for word translation based on ChatGPT API
...
- [Multi-platform desktop app (Windows, Mac, Linux)](https://github.com/lencx/ChatGPT) 51042⭐️ powered by ChatGPT & Tauri
...
- [gptel](https://github.com/karthink/gptel) 982⭐️ GPTel is a simple Large Language Model chat client for Emacs, with support for multiple models and backends.
...
- [gpt4all](https://github.com/nomic-ai/gpt4all) 65554⭐️ a chatbot trained on a massive collection of clean assistant data including code, stories and dialogue
...
- [chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) 26637⭐️ Wechat robot based on ChatGPT, which using OpenAI api and itchat library
...
- [roomGPT](https://github.com/Nutlope/roomGPT) 9663⭐️ Upload a photo of your room to generate your dream room with AI
- [DocsGPT](https://github.com/arc53/DocsGPT) 14309⭐️ GPT-powered chat for documentation search & assistance
...
- [chatbot-ui](https://github.com/mckaywrigley/chatbot-ui) 26895⭐️ An open source ChatGPT UI
- [ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) 71027⭐️ One-Click to deploy your own ChatGPT web UI
...
- [chatgpt-android](https://github.com/skydoves/chatgpt-android) 3570⭐️ ChatGPT Android demonstrates OpenAI's ChatGPT on Android with Stream Chat SDK for Compose
- [ChatGPT for WearOS](https://github.com/DevEmperor/ChatGPT-WearOS) 75⭐️ A powerful ChatGPT app for all WearOS devices
...
- [README-AI](https://github.com/eli64s/README-AI) 1282⭐️ Generate beautiful, informative, and well-structured README.md files. 
...
- [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) 105616⭐️  ChatGPT prompts that works well.
...
- [Mr.-Ranedeer-AI-Tutor](https://github.com/JushBJJ/Mr.-Ranedeer-AI-Tutor) 27344⭐️ A GPT-4 AI Tutor Prompt for customizable personalized learning experiences
