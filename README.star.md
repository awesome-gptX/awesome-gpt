...
- [FastChat](https://github.com/lm-sys/FastChat) 35079⭐️ An open platform for training, serving, and evaluating large language model based chatbots
...
- [chatgpt-tool-hub](https://github.com/goldfishh/chatgpt-tool-hub) 1122⭐️ An open-source chatgpt tool ecosystem where you can combine tools with chatgpt and use natural language to do anything.
- [privateGPT](https://github.com/imartinez/privateGPT) 52496⭐️ Interact privately with your documents using the power of GPT, 100% privately, no data leaks
...
- [gpt4all](https://github.com/nomic-ai/gpt4all) 65555⭐️ a chatbot trained on a massive collection of clean assistant data including code, stories and dialogue
...
- [chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) 26641⭐️ Wechat robot based on ChatGPT, which using OpenAI api and itchat library
...
- [chatgpt_academic](https://github.com/binary-husky/chatgpt_academic) 59887⭐️ Specialized ChatGPT extension for scientific research work, optimized for enhancing the experience of polishing academic papers
- [chatbot-ui](https://github.com/mckaywrigley/chatbot-ui) 26902⭐️ An open source ChatGPT UI
- [ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) 71034⭐️ One-Click to deploy your own ChatGPT web UI
...
- [ChatALL](https://github.com/sunner/ChatALL) 14476⭐️ Concurrently chat with ChatGPT, Bing Chat, bard, Alpaca, Vincuna, Claude, ChatGLM, MOSS, iFlytek Spark, ERNIE and more, discover the best answers
...
- [chatgpt-android](https://github.com/skydoves/chatgpt-android) 3571⭐️ ChatGPT Android demonstrates OpenAI's ChatGPT on Android with Stream Chat SDK for Compose
- [ChatGPT for WearOS](https://github.com/DevEmperor/ChatGPT-WearOS) 75⭐️ A powerful ChatGPT app for all WearOS devices
...
- [ChatGPT-Shortcut](https://github.com/rockbenben/ChatGPT-Shortcut) 5801⭐️ The ChatGPT Shortcut page displays all the prompts by default, and is divided into label area, search area, and prompt display area
...
- [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) 105620⭐️  ChatGPT prompts that works well.
...
- [Mr.-Ranedeer-AI-Tutor](https://github.com/JushBJJ/Mr.-Ranedeer-AI-Tutor) 27347⭐️ A GPT-4 AI Tutor Prompt for customizable personalized learning experiences
...
- [KeepChatGPT](https://github.com/xcanwin/KeepChatGPT) 13969⭐️ A UserScript that enables ChatGPT to chat smoothly, never experiencing network errors again, and no need to refresh the webpage anymore.
