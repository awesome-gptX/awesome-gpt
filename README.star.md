...
- [FastChat](https://github.com/lm-sys/FastChat) 34941⭐️ An open platform for training, serving, and evaluating large language model based chatbots
...
- [GPTCache](https://github.com/zilliztech/GPTCache) 6547⭐️ GPTCache is a library for creating semantic cache to store responses from LLM queries
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 12017⭐️ Clone of ChatGPT, uses official model, reverse-engineered UI, with AI model switching, message search, and prompt templates
...
- [gpt4all](https://github.com/nomic-ai/gpt4all) 65400⭐️ a chatbot trained on a massive collection of clean assistant data including code, stories and dialogue
...
- [ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) 70701⭐️ One-Click to deploy your own ChatGPT web UI
...
- [ChatALL](https://github.com/sunner/ChatALL) 14422⭐️ Concurrently chat with ChatGPT, Bing Chat, bard, Alpaca, Vincuna, Claude, ChatGLM, MOSS, iFlytek Spark, ERNIE and more, discover the best answers
...
- [autodoc](https://github.com/context-labs/autodoc) 1844⭐️ Autodoc is a experimental toolkit for auto-generating codebase documentation for git repositories using Large Language Models, like GPT-4 or Alpaca. 
...
- [Beelzebub ChatGPT Honeypot](https://github.com/mariocandela/beelzebub) 584⭐️ A secure honeypot framework low code, extremely easy to configure by yaml 🚀
...
- [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) 105347⭐️  ChatGPT prompts that works well.
...
- [Mr.-Ranedeer-AI-Tutor](https://github.com/JushBJJ/Mr.-Ranedeer-AI-Tutor) 27172⭐️ A GPT-4 AI Tutor Prompt for customizable personalized learning experiences
