...
- [FastChat](https://github.com/lm-sys/FastChat) 36055⭐️ An open platform for training, serving, and evaluating large language model based chatbots
...
- [privateGPT](https://github.com/imartinez/privateGPT) 53210⭐️ Interact privately with your documents using the power of GPT, 100% privately, no data leaks
...
- [AwesomeChatGPTBot](https://github.com/kourva/AwesomeChatGPTBot) 67⭐️ Free & Rich-Feature ChatGPT Telegram bot for enhanced conversations.
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 16443⭐️ Clone of ChatGPT, uses official model, reverse-engineered UI, with AI model switching, message search, and prompt templates
...
- [openai-translator](https://github.com/yetone/openai-translator) 23361⭐️ A Chrome extension for word translation based on ChatGPT API
...
- [gpt4all](https://github.com/nomic-ai/gpt4all) 68369⭐️ a chatbot trained on a massive collection of clean assistant data including code, stories and dialogue
...
- [chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) 28987⭐️ Wechat robot based on ChatGPT, which using OpenAI api and itchat library
...
- [chatgpt_academic](https://github.com/binary-husky/chatgpt_academic) 63042⭐️ Specialized ChatGPT extension for scientific research work, optimized for enhancing the experience of polishing academic papers
- [chatbot-ui](https://github.com/mckaywrigley/chatbot-ui) 27771⭐️ An open source ChatGPT UI
- [ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) 73745⭐️ One-Click to deploy your own ChatGPT web UI
...
- [AgentGPT](https://github.com/reworkd/AgentGPT) 31015⭐️ 🤖 Assemble, configure, and deploy autonomous AI Agents in your browser.
...
- [ChatALL](https://github.com/sunner/ChatALL) 14905⭐️ Concurrently chat with ChatGPT, Bing Chat, bard, Alpaca, Vincuna, Claude, ChatGLM, MOSS, iFlytek Spark, ERNIE and more, discover the best answers
...
- [aicommits](https://github.com/Nutlope/aicommits) 7601⭐️ A CLI that writes your git commit messages for you with AI
...
- [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) 107909⭐️  ChatGPT prompts that works well.
...
- [Mr.-Ranedeer-AI-Tutor](https://github.com/JushBJJ/Mr.-Ranedeer-AI-Tutor) 28281⭐️ A GPT-4 AI Tutor Prompt for customizable personalized learning experiences
- [prompt-engineering-for-developers](https://github.com/datawhalechina/prompt-engineering-for-developers) 10965⭐️ 吴恩达《ChatGPT Prompt Engineering for Developers》课程中文版
...
- [LangGPT](https://github.com/yzfly/LangGPT) 5055⭐️ Empowering everyone to become a prompt expert!🚀
