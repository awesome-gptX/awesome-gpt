...
### Python 
- [xiaogpt](https://github.com/yihong0618/xiaogpt) 5675⭐️ Play ChatGPT with xiaomi AI speaker
...
- [Auto-GPT](https://github.com/Torantulino/Auto-GPT) 163009⭐️ An experimental open-source attempt to make GPT-4 fully autonomous
- [GPTCache](https://github.com/zilliztech/GPTCache) 6601⭐️ GPTCache is a library for creating semantic cache to store responses from LLM queries
- [gpt4free](https://github.com/xtekky/gpt4free) 58731⭐️ decentralising the Ai Industry, free gpt-4/3.5 scripts through several reverse engineered api's ( poe.com, phind.com, chat.openai.com etc...)
...
- [privateGPT](https://github.com/imartinez/privateGPT) 52629⭐️ Interact privately with your documents using the power of GPT, 100% privately, no data leaks
...
- [openai-translator](https://github.com/yetone/openai-translator) 23083⭐️ A Chrome extension for word translation based on ChatGPT API
...
- [Multi-platform desktop app (Windows, Mac, Linux)](https://github.com/lencx/ChatGPT) 51333⭐️ powered by ChatGPT & Tauri
...
- [gpt4-pdf-chatbot-langchain](https://github.com/mayooear/gpt4-pdf-chatbot-langchain) 14701⭐️ GPT4 & LangChain Chatbot for large PDF docs
...
- [chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) 27208⭐️ Wechat robot based on ChatGPT, which using OpenAI api and itchat library
...
- [ai-research-for-practise](https://github.com/phodal/ai-research-for-practise) 4034⭐️ A powerful image generation model, can through the study of the evolution of an image to generate a new image
...
- [chatgpt_academic](https://github.com/binary-husky/chatgpt_academic) 60229⭐️ Specialized ChatGPT extension for scientific research work, optimized for enhancing the experience of polishing academic papers
- [chatbot-ui](https://github.com/mckaywrigley/chatbot-ui) 27026⭐️ An open source ChatGPT UI
- [ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) 71636⭐️ One-Click to deploy your own ChatGPT web UI
...
- [AgentGPT](https://github.com/reworkd/AgentGPT) 30393⭐️ 🤖 Assemble, configure, and deploy autonomous AI Agents in your browser.
...
- [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) 106025⭐️  ChatGPT prompts that works well.
...
- [prompt-engineering-for-developers](https://github.com/datawhalechina/prompt-engineering-for-developers) 10113⭐️ 吴恩达《ChatGPT Prompt Engineering for Developers》课程中文版
...
- [LangGPT](https://github.com/yzfly/LangGPT) 4163⭐️ Empowering everyone to become a prompt expert!🚀
