...
- [gpt4free](https://github.com/xtekky/gpt4free) 58511⭐️ 通过几个反向工程的API（Poe.com, phind.com, chat.openai.com等），使Ai产业去中心化，免费提供gpt-4/3.5脚本。
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 12092⭐️ 克隆 ChatGPT，使用官方模型，逆向工程 UI，具有 AI 模型切换、信息搜索和提示模板等功能。
...
## 浏览器扩展
- [chatGPTBox](https://github.com/josStorer/chatGPTBox) 9657⭐️ 将 ChatGPT 深度整合到您的浏览器，您需要的一切都在这里。
...
- [chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) 26541⭐️ Wechat robot based on ChatGPT, which using OpenAI api and itchat library
...
- [ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) 70896⭐️ One-Click to deploy your own ChatGPT web UI
...
- [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) 105518⭐️  ChatGPT prompts that works well.
...
- [KeepChatGPT](https://github.com/xcanwin/KeepChatGPT) 13919⭐️ A UserScript that enables ChatGPT to chat smoothly, never experiencing network errors again, and no need to refresh the webpage anymore.
