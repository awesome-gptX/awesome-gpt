...
- [FastChat](https://github.com/lm-sys/FastChat) 38332⭐️ 一个用于训练、服务和评估基于大型语言模型的聊天机器人的开放平台。
...
- [Auto-GPT](https://github.com/Torantulino/Auto-GPT) 174294⭐️ 使 GPT-4 完全的实验性开源尝试。
- [GPTCache](https://github.com/zilliztech/GPTCache) 7501⭐️ GPTCache 是一个创建语义缓存的库，用于存储 LLM 查询的响应。
- [gpt4free](https://github.com/xtekky/gpt4free) 63989⭐️ 通过几个反向工程的API（Poe.com, phind.com, chat.openai.com等），使Ai产业去中心化，免费提供gpt-4/3.5脚本。
- [gpt4free-ts](https://github.com/xiangsx/gpt4free-ts) 7758⭐️ 提供免费的 OpenAI GPT-4 API!这是一个复制 xtekky/gpt4free TypeScript版本的项目。
- [MiniGPT-4](https://github.com/Vision-CAIR/MiniGPT-4) 25635⭐️ MiniGPT-4：用先进的大型语言模型加强视觉-语言理解
- [chatgpt-tool-hub](https://github.com/goldfishh/chatgpt-tool-hub) 1284⭐️ 一个开源的聊天GPT工具生态系统,您可以将工具组合到聊天GPT中,通过自然语言来实现任何操作。
- [privateGPT](https://github.com/imartinez/privateGPT) 55582⭐️ 利用GPT的能力,以全然私密的方式与您的文档进行互动,100%保密,没有任何数据泄漏。
...
- [Casibase](https://github.com/casibase/casibase) 3466⭐️ Casibase 提供一个开源的类 LangChain 人工智能知识数据库和聊天机器人，使用 Golang 构建，具有管理用户界面并支持多种模型（DeepSeek R1、ChatGPT、Claude、Llama 3、HuggingFace 等）。能够提供人工智能驱动的智能回复。
...
- [Unofficial API in JS/TS](https://github.com/transitive-bullshit/chatgpt-api) 17291⭐️ 用于官方 ChatGPT API 的 Node.js 客户端.
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 24303⭐️ 克隆 ChatGPT，使用官方模型，逆向工程 UI，具有 AI 模型切换、信息搜索和提示模板等功能。
...
## 浏览器扩展
- [chatGPTBox](https://github.com/josStorer/chatGPTBox) 10465⭐️ 将 ChatGPT 深度整合到您的浏览器，您需要的一切都在这里。
- [chatgpt-google-summary-extension](https://github.com/sparticleinc/chatgpt-google-summary-extension) 1952⭐️ 在 Google 搜索结果和 YouTube 视频旁边查看ChatGPT摘要，也支持 Yahoo!
...
## 命令行工具
- [README-AI](https://github.com/eli64s/README-AI) 1911⭐️ 使用 OpenAI 语言模型 API，为编写美观、结构化和信息丰富的 README.md 文件而设计的命令行工具。
