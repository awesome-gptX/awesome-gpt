...
- [FastChat](https://github.com/lm-sys/FastChat) 35195⭐️ 一个用于训练、服务和评估基于大型语言模型的聊天机器人的开放平台。
...
- [chatgpt-tool-hub](https://github.com/goldfishh/chatgpt-tool-hub) 1131⭐️ 一个开源的聊天GPT工具生态系统,您可以将工具组合到聊天GPT中,通过自然语言来实现任何操作。
...
## 命令行工具
- [README-AI](https://github.com/eli64s/README-AI) 1295⭐️ 使用 OpenAI 语言模型 API，为编写美观、结构化和信息丰富的 README.md 文件而设计的命令行工具。
