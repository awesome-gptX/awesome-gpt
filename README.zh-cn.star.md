...
### Python
- [xiaogpt](https://github.com/yihong0618/xiaogpt) 5548⭐️ 用小米 AI speaker 播放 ChatGPT。
...
- [FastChat](https://github.com/lm-sys/FastChat) 35127⭐️ 一个用于训练、服务和评估基于大型语言模型的聊天机器人的开放平台。
...
- [Auto-GPT](https://github.com/Torantulino/Auto-GPT) 162807⭐️ 使 GPT-4 完全的实验性开源尝试。
- [GPTCache](https://github.com/zilliztech/GPTCache) 6580⭐️ GPTCache 是一个创建语义缓存的库，用于存储 LLM 查询的响应。
- [gpt4free](https://github.com/xtekky/gpt4free) 58601⭐️ 通过几个反向工程的API（Poe.com, phind.com, chat.openai.com等），使Ai产业去中心化，免费提供gpt-4/3.5脚本。
...
- [chatgpt-java](https://github.com/PlexPt/chatgpt-java) 3485⭐️ ChatGPT Java SDK. 用于与 OpenAI 的 ChatGPT 的 API 进行交互的轻量级包。
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 12195⭐️ 克隆 ChatGPT，使用官方模型，逆向工程 UI，具有 AI 模型切换、信息搜索和提示模板等功能。
...
## 浏览器扩展
- [chatGPTBox](https://github.com/josStorer/chatGPTBox) 9674⭐️ 将 ChatGPT 深度整合到您的浏览器，您需要的一切都在这里。
- [chatgpt-google-summary-extension](https://github.com/sparticleinc/chatgpt-google-summary-extension) 1666⭐️ 在 Google 搜索结果和 YouTube 视频旁边查看ChatGPT摘要，也支持 Yahoo!
