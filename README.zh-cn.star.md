...
- [FastChat](https://github.com/lm-sys/FastChat) 39137⭐️ 一个用于训练、服务和评估基于大型语言模型的聊天机器人的开放平台。
...
- [Auto-GPT](https://github.com/Torantulino/Auto-GPT) 178901⭐️ 使 GPT-4 完全的实验性开源尝试。
- [GPTCache](https://github.com/zilliztech/GPTCache) 7786⭐️ GPTCache 是一个创建语义缓存的库，用于存储 LLM 查询的响应。
...
- [Casibase](https://github.com/casibase/casibase) 4102⭐️ Casibase 提供一个开源的类 LangChain 人工智能知识数据库和聊天机器人，使用 Golang 构建，具有管理用户界面并支持多种模型（DeepSeek R1、ChatGPT、Claude、Llama 3、HuggingFace 等）。能够提供人工智能驱动的智能回复。
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 30648⭐️ 克隆 ChatGPT，使用官方模型，逆向工程 UI，具有 AI 模型切换、信息搜索和提示模板等功能。
...
- [Automate your browser with GPT-4](https://github.com/TaxyAI/browser-extension) 1239⭐️ 使用 GPT-4 来控制你的浏览器并代表你执行重复性的动作。
...
- [openai-translator](https://github.com/yetone/openai-translator) 24625⭐️ A Chrome extension for word translation based on ChatGPT API
...
- [Multi-platform desktop app (Windows, Mac, Linux)](https://github.com/lencx/ChatGPT) 54156⭐️ powered by ChatGPT & Tauri
...
## 聊天机器人
- [gpt4all](https://github.com/nomic-ai/gpt4all) 76770⭐️ a chatbot trained on a massive collection of clean assistant data including code, stories and dialogue
...
- [gpt4-pdf-chatbot-langchain](https://github.com/mayooear/gpt4-pdf-chatbot-langchain) 16040⭐️ GPT4 & LangChain Chatbot for large PDF docs
...
- [chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) 39304⭐️ Wechat robot based on ChatGPT, which using OpenAI api and itchat library
...
- [ai-research-for-practise](https://github.com/phodal/ai-research-for-practise) 4920⭐️ A powerful image generation model, can through the study of the evolution of an image to generate a new image
- [roomGPT](https://github.com/Nutlope/roomGPT) 10568⭐️ Upload a photo of your room to generate your dream room with AI
- [DocsGPT](https://github.com/arc53/DocsGPT) 17169⭐️ GPT-powered chat for documentation search & assistance
...
- [chatgpt_academic](https://github.com/binary-husky/chatgpt_academic) 69309⭐️ Specialized ChatGPT extension for scientific research work, optimized for enhancing the experience of polishing academic papers
- [chatbot-ui](https://github.com/mckaywrigley/chatbot-ui) 32428⭐️ An open source ChatGPT UI
- [ChatGPT-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) 86038⭐️ One-Click to deploy your own ChatGPT web UI
- [BibiGPT](https://github.com/JimmyLv/BibiGPT) 5728⭐️ One-click summary for video & audio content: Bilibili | YouTube | Websites丨Podcasts | Meetings | Local files, etc
...
- [AgentGPT](https://github.com/reworkd/AgentGPT) 35035⭐️ 🤖 Assemble, configure, and deploy autonomous AI Agents in your browser.
...
## 命令行工具
- [README-AI](https://github.com/eli64s/README-AI) 2707⭐️ 使用 OpenAI 语言模型 API，为编写美观、结构化和信息丰富的 README.md 文件而设计的命令行工具。
...
## Cybersecurity
- [Beelzebub ChatGPT Honeypot](https://github.com/mariocandela/beelzebub) 1570⭐️ A secure honeypot framework low code, extremely easy to configure by yaml 🚀
...
## 提示
- [ChatGPT-Shortcut](https://github.com/rockbenben/ChatGPT-Shortcut) 6397⭐️ The ChatGPT Shortcut page displays all the prompts by default, and is divided into label area, search area, and prompt display area
...
- [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) 135097⭐️  ChatGPT prompts that works well.
