...
- [Auto-GPT](https://github.com/Torantulino/Auto-GPT) 162839⭐️ 使 GPT-4 完全的实验性开源尝试。
...
- [Unoffical API in Python](https://github.com/acheong08/ChatGPT) 27979⭐️ 反向工程的 ChatGPT API
...
- [Unofficial API in JS/TS](https://github.com/transitive-bullshit/chatgpt-api) 15749⭐️ 用于官方 ChatGPT API 的 Node.js 客户端.
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 12215⭐️ 克隆 ChatGPT，使用官方模型，逆向工程 UI，具有 AI 模型切换、信息搜索和提示模板等功能。
