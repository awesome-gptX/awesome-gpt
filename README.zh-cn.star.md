...
- [Auto-GPT](https://github.com/Torantulino/Auto-GPT) 162647⭐️ 使 GPT-4 完全的实验性开源尝试。
...
- [DemoGPT](https://github.com/melih-unsal/DemoGPT) 1598⭐️ 🧩 DemoGPT 允许您仅通过提示就可以快速创建演示。
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 12085⭐️ 克隆 ChatGPT，使用官方模型，逆向工程 UI，具有 AI 模型切换、信息搜索和提示模板等功能。
