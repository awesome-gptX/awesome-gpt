...
- [FastChat](https://github.com/lm-sys/FastChat) 35031⭐️ 一个用于训练、服务和评估基于大型语言模型的聊天机器人的开放平台。
...
- [privateGPT](https://github.com/imartinez/privateGPT) 52458⭐️ 利用GPT的能力,以全然私密的方式与您的文档进行互动,100%保密,没有任何数据泄漏。
...
- [Unofficial API in JS/TS](https://github.com/transitive-bullshit/chatgpt-api) 15702⭐️ 用于官方 ChatGPT API 的 Node.js 客户端.
...
## 浏览器扩展
- [chatGPTBox](https://github.com/josStorer/chatGPTBox) 9658⭐️ 将 ChatGPT 深度整合到您的浏览器，您需要的一切都在这里。
