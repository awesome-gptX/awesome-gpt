...
### Python
- [xiaogpt](https://github.com/yihong0618/xiaogpt) 5572⭐️ 用小米 AI speaker 播放 ChatGPT。
...
- [Auto-GPT](https://github.com/Torantulino/Auto-GPT) 162829⭐️ 使 GPT-4 完全的实验性开源尝试。
- [GPTCache](https://github.com/zilliztech/GPTCache) 6581⭐️ GPTCache 是一个创建语义缓存的库，用于存储 LLM 查询的响应。
- [gpt4free](https://github.com/xtekky/gpt4free) 58615⭐️ 通过几个反向工程的API（Poe.com, phind.com, chat.openai.com等），使Ai产业去中心化，免费提供gpt-4/3.5脚本。
...
- [Unofficial API in JS/TS](https://github.com/transitive-bullshit/chatgpt-api) 15727⭐️ 用于官方 ChatGPT API 的 Node.js 客户端.
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 12206⭐️ 克隆 ChatGPT，使用官方模型，逆向工程 UI，具有 AI 模型切换、信息搜索和提示模板等功能。
