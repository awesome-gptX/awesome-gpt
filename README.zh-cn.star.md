...
### Python
- [xiaogpt](https://github.com/yihong0618/xiaogpt) 5520⭐️ 用小米 AI speaker 播放 ChatGPT。
...
- [FastChat](https://github.com/lm-sys/FastChat) 35113⭐️ 一个用于训练、服务和评估基于大型语言模型的聊天机器人的开放平台。
...
- [Auto-GPT](https://github.com/Torantulino/Auto-GPT) 162773⭐️ 使 GPT-4 完全的实验性开源尝试。
...
- [MiniGPT-4](https://github.com/Vision-CAIR/MiniGPT-4) 25046⭐️ MiniGPT-4：用先进的大型语言模型加强视觉-语言理解
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 12175⭐️ 克隆 ChatGPT，使用官方模型，逆向工程 UI，具有 AI 模型切换、信息搜索和提示模板等功能。
...
## 命令行工具
- [README-AI](https://github.com/eli64s/README-AI) 1285⭐️ 使用 OpenAI 语言模型 API，为编写美观、结构化和信息丰富的 README.md 文件而设计的命令行工具。
