...
### Python
- [xiaogpt](https://github.com/yihong0618/xiaogpt) 5688⭐️ 用小米 AI speaker 播放 ChatGPT。
...
- [FastChat](https://github.com/lm-sys/FastChat) 35263⭐️ 一个用于训练、服务和评估基于大型语言模型的聊天机器人的开放平台。
...
- [gpt4free](https://github.com/xtekky/gpt4free) 58770⭐️ 通过几个反向工程的API（Poe.com, phind.com, chat.openai.com等），使Ai产业去中心化，免费提供gpt-4/3.5脚本。
...
- [privateGPT](https://github.com/imartinez/privateGPT) 52647⭐️ 利用GPT的能力,以全然私密的方式与您的文档进行互动,100%保密,没有任何数据泄漏。
- [ChatGPT-ShellMaster](https://github.com/VolkanSah/ChatGPT-ShellMaster) 46⭐️ ChatGPT ShellMaster 通过聊天使用OpenAI的ChatGPT启用命令行交互。
- [DemoGPT](https://github.com/melih-unsal/DemoGPT) 1610⭐️ 🧩 DemoGPT 允许您仅通过提示就可以快速创建演示。
