...
### Python
- [xiaogpt](https://github.com/yihong0618/xiaogpt) 5646⭐️ 用小米 AI speaker 播放 ChatGPT。
...
- [gpt4free-ts](https://github.com/xiangsx/gpt4free-ts) 7515⭐️ 提供免费的 OpenAI GPT-4 API!这是一个复制 xtekky/gpt4free TypeScript版本的项目。
...
- [chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) 12316⭐️ 克隆 ChatGPT，使用官方模型，逆向工程 UI，具有 AI 模型切换、信息搜索和提示模板等功能。
