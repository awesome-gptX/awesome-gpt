...
- [FastChat](https://github.com/lm-sys/FastChat) 35074⭐️ 一个用于训练、服务和评估基于大型语言模型的聊天机器人的开放平台。
...
- [Auto-GPT](https://github.com/Torantulino/Auto-GPT) 162715⭐️ 使 GPT-4 完全的实验性开源尝试。
...
- [gpt4free-ts](https://github.com/xiangsx/gpt4free-ts) 7502⭐️ 提供免费的 OpenAI GPT-4 API!这是一个复制 xtekky/gpt4free TypeScript版本的项目。
