...
- [FastChat](https://github.com/lm-sys/FastChat) 35267⭐️ 一个用于训练、服务和评估基于大型语言模型的聊天机器人的开放平台。
...
- [privateGPT](https://github.com/imartinez/privateGPT) 52654⭐️ 利用GPT的能力,以全然私密的方式与您的文档进行互动,100%保密,没有任何数据泄漏。
